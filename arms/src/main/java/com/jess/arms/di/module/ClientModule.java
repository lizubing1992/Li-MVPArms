...
public class ClientModule {
    ...
    @Singleton
    @Provides
    RxCache provideRxCache(Application application) {
        return new RxCache
                .Builder()
                .persistence(DataHelper.getDataCacheFile(application), new GsonSpeaker());
    }
    ...
    private OkHttpClient configureClient(OkHttpClient.Builder okHttpClient, Cache cache, Interceptor intercept) {
        ...
        OkHttpClient.Builder builder = okHttpClient
                ...
                /**
                 * okhttp会根据Response 中的cache-Control 来缓存数据
                 */
//                .cache(cache)//设置缓存
