...
public class NewsListModule {
    ...
    @ActivityScope
    @Provides
    NewsListContract.Model provideNewsListModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new NewsListModel(serviceManager, cacheManager, gson, application);
    }
}