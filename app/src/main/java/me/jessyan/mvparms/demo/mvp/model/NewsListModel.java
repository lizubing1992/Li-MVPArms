...
public class NewsListModel extends BaseModel<ServiceManager, CacheManager> implements NewsListContract.Model {
    private Gson mGson;
    private Application mApplication;
    private CommonService mCommonService;
    private CommonCache mCommonCache;

    public NewsListModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<NewsListEntity> getNewsList(String cacheName, int page, int id, final boolean update) {

        Observable<NewsListEntity> newsList = mCommonService
                .getNewsList(page, id);
        ...
        return mCommonCache
                ...
                .flatMap(new Func1<Reply<NewsListEntity>, Observable<NewsListEntity>>() {
                    @Override
                    public Observable<NewsListEntity> call(Reply<NewsListEntity> listReply) {
                        Timber.tag("NewsListEntity").w("NewsListModel+info信息"+listReply.getData().getTngou().size()+"update"+update);
