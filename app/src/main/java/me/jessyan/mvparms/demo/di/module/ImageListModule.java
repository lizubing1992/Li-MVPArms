...
public class ImageListModule {
    ...
    @ActivityScope
    @Provides
    ImageListContract.Model provideImageListModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new ImageListModel(serviceManager, cacheManager, gson, application);
    }
}