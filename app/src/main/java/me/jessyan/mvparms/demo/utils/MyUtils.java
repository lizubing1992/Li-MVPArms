...
public class MyUtils {
    ...
    public static boolean isNightMode() {
        SharedPreferences preferences = WEApplication.getContext().getSharedPreferences(
    ...
    public static SharedPreferences getSharedPreferences() {
        return WEApplication.getContext()
...
//            KLog.e("转换新闻日期格式异常：" + e.toString());
    ...
    public static int getScreenWith() {
        return WEApplication.getContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static String analyzeNetworkError(Throwable e) {
        String errMsg = WEApplication.getContext().getString(R.string.load_error);
        if (e instanceof HttpException) {
            int state = ((HttpException) e).code();
            if (state == 403) {
                errMsg = WEApplication.getContext().getString(R.string.retry_after);
            }
        }
        return errMsg;
    }
