...
import me.jessyan.mvparms.demo.utils.ScalarsConverterFactory;
...
//                    retrofitBuilder.addConverterFactory(new ScalarsConverterFactory());//比如使用fastjson替代gson
                })
    ...
    public void injectAppLifecycle(Context context, List<AppDelegate.Lifecycle> lifecycles) {
        ...
        lifecycles.add(new AppDelegate.Lifecycle() {
            ...
            public void onCreate(Application application) {
                ...
                //leakCanary内存泄露检查
                ((App) application).getAppComponent().extras().put(RefWatcher.class.getName(), BuildConfig.USE_CANARY ? LeakCanary
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                if (activity.findViewById(R.id.toolbar) != null) {
                    if (activity instanceof AppCompatActivity) {
                        ((AppCompatActivity) activity).setSupportActionBar((Toolbar) activity.findViewById(
                            R.id.toolbar));
